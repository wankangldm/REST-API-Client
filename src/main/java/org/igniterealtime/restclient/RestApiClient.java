...
public class RestApiClient {
	...
	/**
	 * by wankang
	 * 新增方法,使其返回json字符串,而不是UserEntities对象
	 * @param queryParams
	 * @return
	 */
	public String getUsers_json(HashMap<String, String> queryParams) {
		String UsersJson = restClient.get("users", String.class, queryParams);
		return UsersJson;
	 ...
	 * @return the user groups
	 */
	public String getUserSharedGroups(String username) {
		return restClient.get("users/" + username + "/sharedgroups", String.class,
				new HashMap<String, String>());
	}
